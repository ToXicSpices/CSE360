...
public class ViewFirstAdmin {
	...
	//private static Button button_AdminEmailHelp = new Button("?");
	...
	private ViewFirstAdmin() {
		...
		setupTextUI(text_AdminPassword2, "Arial", 18, 300, Pos.BASELINE_LEFT, 50, 270, 
				true);
		...
		text_AdminEmail.setText("");
		setupTextUI(text_AdminEmail, "Arial", 18, 300, Pos.BASELINE_LEFT, 50, 320, 
				true);
		text_AdminEmail.setPromptText("Enter Admin Email");
		text_AdminEmail.textProperty().addListener((observable, oldValue, newValue) 
		...
		button_AdminShowPassword.setOnAction((event) -> {
		...
		button_AdminHidePassword.setOnAction((event) -> {
		...
		// Alert to display the error message if any of the input is invalid
		alertSignUpError.setTitle("Invalid username/password!");
		alertSignUpError.setHeaderText(null);

		// Establish the help button for the Admin username
		setupButtonUI(button_AdminUsernameHelp, "Dialog", 18, 18, Pos.BASELINE_LEFT, 350, 160);
		button_AdminUsernameHelp.setOnAction((event) -> {
			ViewFirstAdmin.alertSignUpError.setTitle("Username/Password Help");
			ViewFirstAdmin.alertSignUpError.setHeaderText("Username Requirements:");
		...
		// Establish the help button for the Admin password
		setupButtonUI(button_AdminPasswordHelp, "Dialog", 18, 18, Pos.BASELINE_LEFT, 350, 210);
		button_AdminPasswordHelp.setOnAction((event) -> {
			ViewFirstAdmin.alertSignUpError.setTitle("Username/Password Help");
			ViewFirstAdmin.alertSignUpError.setHeaderText("Password Requirements:");
			ViewFirstAdmin.alertSignUpError.setContentText(
