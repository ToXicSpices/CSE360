...
public class PostValidator {
	 ...
	 * 
	 */
	public static String checkValidSubtitle(String subtitle) {
	 ...
	 * 
	 */
	public static String checkValidContent(String content) {
	 ...
	 * 
	 */
	public static String checkValidTag(String tag) {
		if (tag.length() < 2) {
